...
client.on("messageCreate", async (message) => {
  ...
  if (
    ...
    dbGuild?.allowedChannels.length > 0 &&
    !dbGuild.allowedChannels.includes(message.channel.id)
  ) {
    ...
    message
      .reply(`Wrong channel! Try the ${channels[0]} channel instead`)
      .then((r) => {
        setTimeout(() => {
          message.delete();
          r.delete();
